...
for polygon in total_logins:
    final_geojson_string += '''{ "type": "Feature", "properties":{}, "geometry": { "type": "Polygon", "coordinates": [ [ [ '''+ str(polygon[0][0]) + ''', ''' + str(polygon[0][1]) + ''' ], [ ''' + str(polygon[3][0]) + ''', ''' + str(polygon[3][1]) + ''' ], [ ''' + str(polygon[2][0]) + ''', ''' + str(polygon[2][1]) + ''' ], [ ''' + str(polygon[1][0]) + ''', ''' + str(polygon[1][1]) + ''' ], [ ''' + str(polygon[0][0]) + ''', ''' + str(polygon[0][1]) + ''' ] ] ] } },'''
